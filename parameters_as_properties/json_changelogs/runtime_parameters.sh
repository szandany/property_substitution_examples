...
# printing and confirming values with updateSQL
liquibase --url=jdbc:h2:mem:liquibase --changeLogFile=test_variables1.json updateSQL -Dtable.name=myTable3 -DmySpecialValue=CHAR\(10\)
liquibase --url=jdbc:h2:mem:liquibase --changeLogFile=test_variables1.json update -Dtable.name=myTable3 -DmySpecialValue=CHAR\(10\)